...
namespace Xiaowei.API
{
    ...
    /// 小微商户业务函数
    /// 感谢 烟雨弥漫了江南 分享的文章
    /// https://blog.csdn.net/u010324331
    /// </summary>
    public class XiaoWei
    {
        ...
        /// <summary>
        /// 加密敏感信息，传入明文和从微信支付获取到的敏感信息加密公钥
        /// 事先使用OpenSSL转换cert.pem文件输出为der文件
